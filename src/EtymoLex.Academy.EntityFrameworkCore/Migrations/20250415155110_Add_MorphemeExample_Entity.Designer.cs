...
namespace EtymoLex.Academy.Migrations
{
    ...
    [Migration("20250415155110_Add_MorphemeExample_Entity")]
    partial class Add_MorphemeExample_Entity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EtymoLex.Academy.Morpheme", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    NpgsqlIndexBuilderExtensions.AreNullsDistinct(b.HasIndex("TenantId", "Value"), false);

                    b.ToTable("EtymoLex_Morphemes", (string)null);
                });

            modelBuilder.Entity("EtymoLex.Academy.MorphemeExample", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    NpgsqlIndexBuilderExtensions.AreNullsDistinct(b.HasIndex("TenantId", "Word"), false);

                    b.ToTable("EtymoLex_MorphemeExamples", (string)null);
                });
            ...
            modelBuilder.Entity("EtymoLex.Academy.MorphemeExample", b =>
                {
                    b.HasOne("EtymoLex.Academy.Morpheme", "Parent")
                        .WithMany("Examples")
